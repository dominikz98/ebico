...
/// <summary>
/// Convenience upload request for a <b>SEPA Credit Transfer</b> (order type <c>CCT</c>, a
/// <c>pain.001</c> message). Equivalent to a <see cref="UploadRequest"/> with
/// <see cref="UploadRequest.OrderType"/> = <c>"CCT"</c>.
/// </summary>
public sealed class CctUploadRequest : IEbicsRequest<UploadResult>, IPaymentUploadRequest
{
    /// <summary>The <c>pain.001</c> credit-transfer message to upload, as raw bytes.</summary>
    ...
    /// <inheritdoc />
    string IPaymentUploadRequest.OrderType => PaymentOrderTypes.CreditTransfer;
