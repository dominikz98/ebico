...
/// <summary>
/// The H004 (EBICS 2.5) HCA handler. Like H003 it is a <b>pure-key</b> procedure: the new
...
/// </summary>
public sealed class H004HcaOrderHandler : HcaOrderHandlerBase
{
    ...
    public H004HcaOrderHandler(IMasterDataManager masterData, IServerKeyStore keyStore, IServerBankKeyStore bankKeyStore)
    ...
    protected override HcaEnvelope ExtractEnvelope(EbicsRequestContext context)
    {
        var request = context.Envelope as H.EbicsRequest
            ?? throw new InvalidDataException("The HCA request is not an H004 ebicsRequest.");
