...
/// <summary>
/// The H004 download envelope builder. Downloads are requested either via the generic <c>"FDL"</c>
...
/// </summary>
internal sealed class H004DownloadEnvelopeBuilder : DownloadEnvelopeBuilderBase
{
    /// <inheritdoc />
