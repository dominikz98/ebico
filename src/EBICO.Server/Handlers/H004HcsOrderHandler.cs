...
/// <summary>
/// The H004 (EBICS 2.5) HCS handler. Like H003 it is a <b>pure-key</b> procedure: the new signature
...
/// </summary>
public sealed class H004HcsOrderHandler : HcsOrderHandlerBase
{
    ...
    public H004HcsOrderHandler(IMasterDataManager masterData, IServerKeyStore keyStore, IServerBankKeyStore bankKeyStore)
    ...
    protected override HcsEnvelope ExtractEnvelope(EbicsRequestContext context)
    {
        var request = context.Envelope as H.EbicsRequest
            ?? throw new InvalidDataException("The HCS request is not an H004 ebicsRequest.");
